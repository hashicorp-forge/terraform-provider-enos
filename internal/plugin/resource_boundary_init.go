...
import (
	...
	"github.com/hashicorp-forge/terraform-provider-enos/internal/remoteflight/boundary"
...
`),
			Attributes: []*tfprotov6.SchemaAttribute{
				...
				},
				{
					...
					Type:        tftypes.String,
					Optional:    true,
					Description: "The name of boundary binary we're going to use when initializing the cluster",
				},
				{
					Name:        "bin_path",
					Type:        tftypes.String,
					Required:    true,
					Description: "The path to the directory with binary we're going to use when initializing the cluster",
				},
				{
					Name:        "config_path",
					Type:        tftypes.String,
					Required:    true,
					Description: "The path to the Boundary configuration to use when initializing the cluster",
				},
				{
					Name:        "license",
					Type:        tftypes.String,
				...
				},
				{
					...
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary auth method ID",
				},
				{
					Name:        "auth_method_name",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary auth method name",
				},
				{
					Name:        "auth_login_name",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary auth login name",
				},
				{
					Name:        "auth_password",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary auth password",
				},
				{
					Name:        "auth_scope_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary auth scope ID",
				},
				{
					Name:        "auth_user_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary auth user ID",
				},
				{
					Name:        "auth_user_name",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary auth user name",
				},
				{
					Name:        "host_catalog_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary host catalog ID",
				},
				{
					Name:        "host_set_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary host set ID",
				},
				{
					Name:        "host_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary host ID",
				},
				{
					Name:        "host_type",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary host type",
				},
				{
					Name:        "host_scope_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary host scope ID",
				},
				{
					Name:        "host_catalog_name",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary host catalog name",
				},
				{
					Name:        "host_set_name",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary host set name",
				},
				{
					Name:        "host_name",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary host name",
				},
				{
					Name:        "login_role_scope_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary login role scope ID",
				},
				{
					Name:        "login_role_name",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary login role name",
				},
				{
					Name:        "org_scope_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary org scope ID",
				},
				{
					Name:        "org_scope_type",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary org scope type",
				},
				{
					Name:        "org_scope_name",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary org scope name",
				},
				{
					Name:        "project_scope_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary project scope name",
				},
				{
					Name:        "project_scope_type",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary project scope type",
				},
				{
				...
				},
				{
					...
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary target id",
				},
				{
					Name:        "target_default_port",
					Type:        tftypes.Number,
					Computed:    true,
					Description: "The autogenerated Boundary target default port",
				},
				{
					Name:        "target_session_max_seconds",
					Type:        tftypes.Number,
					Computed:    true,
					Description: "The autogenerated Boundary target session max seconds",
				},
				{
					Name:        "target_session_connection_limit",
					Type:        tftypes.Number,
					Computed:    true,
					Description: "The autogenerated Boundary target session connection limit",
				},
				{
					Name:        "target_type",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary target type",
				},
				{
					Name:        "target_scope_id",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary target scope ID",
				},
				{
					Name:        "target_name",
					Type:        tftypes.String,
					Computed:    true,
					Description: "The autogenerated Boundary target name",
				},
