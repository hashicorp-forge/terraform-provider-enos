...
func TestTFNumGetAndValue(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			"null",
			&tfNum{Unknown: false, Null: true, Val: 4},
		...
		{
			"known",
			&tfNum{Unknown: false, Null: false, Val: 5},
...
func TestTFStringGetAndValue(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			"unknown",
			&tfString{Unknown: true, Null: false, Val: "1"},
		...
		{
			"null",
			&tfString{Unknown: false, Null: true, Val: "2"},
		...
		{
			"known",
			&tfString{Unknown: false, Null: false, Val: "5"},
...
func TestTFStringSliceGetAndValue(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			"unknown",
			&tfStringSlice{Unknown: true, Null: false, Val: []*tfString{{Unknown: false, Null: false, Val: "foo"}}},
		...
		{
			"null",
			&tfStringSlice{Unknown: false, Null: true, Val: []*tfString{{Unknown: false, Null: false, Val: "foo"}}},
		...
		{
			"fully known",
			&tfStringSlice{Unknown: false, Null: false, Val: []*tfString{{Unknown: false, Null: false, Val: "foo"}, {Unknown: false, Null: false, Val: "bar"}}},
		...
		},
		{
			...
			&tfStringSlice{Unknown: false, Null: false, Val: []*tfString{{Unknown: true, Null: false, Val: ""}}},
			tftypes.NewValue(tftypes.List{ElementType: tftypes.String}, []tftypes.Value{
				tftypes.NewValue(tftypes.String, tftypes.UnknownValue),
			}),
			[]string{},
...
func TestTFStringMapGetAndValue(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			"unknown",
			&tfStringMap{Unknown: true, Null: false, Val: map[string]*tfString{"foo": {Unknown: false, Null: false, Val: "foo"}}},
		...
		{
			"null",
			&tfStringMap{Unknown: false, Null: true, Val: map[string]*tfString{"foo": {Unknown: false, Null: false, Val: "foo"}}},
		...
		{
			"fully known",
			&tfStringMap{Unknown: false, Null: false, Val: map[string]*tfString{"foo": {Unknown: false, Null: false, Val: "foo"}, "bar": {Unknown: false, Null: false, Val: "bar"}}},
		...
		{
			"known with unknown child",
			&tfStringMap{Unknown: false, Null: false, Val: map[string]*tfString{"foo": {Unknown: true, Null: false, Val: ""}}},
			tftypes.NewValue(tftypes.Map{ElementType: tftypes.String}, map[string]tftypes.Value{
...
func TestTFObjectGetAndValue(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			func() *tfObject {
				obj := newTfObject()
				obj.Set(map[string]any{"foo": &tfString{Unknown: false, Null: false, Val: "foo"}, "bar": &tfBool{Unknown: false, Null: false, Val: false}})
				obj.Unknown = true
		...
		},
		{
			...
			func() *tfObject {
				obj := newTfObject()
				obj.Set(map[string]any{"foo": &tfString{Unknown: true, Null: false, Val: ""}, "bar": &tfBool{Unknown: false, Null: false, Val: false}})
...
func TestDebugTfString(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			&tfString{Unknown: true, Null: false, Val: ""},
			"unknown",
		},
		{
			&tfString{Unknown: false, Null: false, Val: "bananas"},
			"bananas",
		},
	} {
...
func TestDebugTfNum(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			&tfNum{Unknown: true, Null: false, Val: 0},
			"unknown",
		},
		{
			&tfNum{Unknown: false, Null: false, Val: 50},
			"50",
		},
	} {
		assert.Equal(t, test.expectedDebug, test.val.String())
...
func TestDebugTfStringSlice(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			&tfStringSlice{Unknown: true, Null: false, Val: []*tfString{}},
			"unknown",
		},
		{
			&tfStringSlice{Unknown: false, Null: false, Val: []*tfString{{Unknown: false, Null: false, Val: "bananas"}, {Unknown: false, Null: false, Val: "apples"}, {Unknown: false, Null: false, Val: "mangos"}}},
...
func TestDebugTfStringMap(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			&tfStringMap{Unknown: true, Null: false, Val: map[string]*tfString{}},
			"unknown",
		},
		{
			sMap,
...
func TestDebugTfObject(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			&tfObject{Unknown: true, Null: false, AttrTypes: map[string]tftypes.Type{}, Val: map[string]any{}, Optional: map[string]struct{}{}},
			"unknown",
		},
		{
			object,
...
func TestDebugTfObjectSlice(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			&tfObjectSlice{Unknown: true, Null: false, Val: []*tfObject{}, AttrTypes: map[string]tftypes.Type{}, Optional: map[string]struct{}{}},
			"unknown",
		},
		{
			slice,
