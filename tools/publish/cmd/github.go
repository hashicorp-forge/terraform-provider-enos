...
func newGithubReleaseCreateCmd() *cobra.Command {
	...
	ghReleaseCreateCmd.PersistentFlags().StringVar(&githubReleaseCreateReq.GPGKeyID, "gpg-key-id", "5D67D7B072C16294", "the GPG Signing Key")
	ghReleaseCreateCmd.PersistentFlags().StringVar(&githubReleaseCreateReq.GPGIdentityName, "gpg-identity-name", "team-secure-quality@hashicorp.com", "the GPG identity name, should be an email address")
